      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-500 max-w-xs">
          ...
          <div className="flex gap-12">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-500">
                ...
                <li>
                  <a href="#demo" className="hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                    Demo
                  </a>
                </li>
              </ul>
        ...
        {/* Bottom bar */}
        <div className="mt-12 pt-6 border-t border-gray-200/50 dark:border-gray-800/50 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-500 dark:text-gray-600">
